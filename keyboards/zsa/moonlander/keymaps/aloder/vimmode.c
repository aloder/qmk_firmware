...
const char keycode_to_char_map[58] = {NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, 'a', 'b', 'c', 'd', 'e', NO_CHAR, 'g', 'h', 'i', 'j', 'k', 'l', NO_CHAR, NO_CHAR, 'o', 'p', 'q', 'r', NO_CHAR, NO_CHAR, 'u', 'v', 'w', 'x', 'y', NO_CHAR, '1', '2', '3', '4', '5', '6', '7', '8', '9', '0', NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, ' ', NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, '\\', NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, '.', '/'};

const char keycode_to_char_map_shifted[58] = {NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, 'A', NO_CHAR, 'C', 'D', NO_CHAR, NO_CHAR, 'G', NO_CHAR, 'I', NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, 'O', 'P', NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, 'U', 'V', NO_CHAR, 'X', NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, '$', NO_CHAR, '^', NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, '|', NO_CHAR, ':', NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR, NO_CHAR};
